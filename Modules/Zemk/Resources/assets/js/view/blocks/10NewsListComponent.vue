<template>
  <div class="container my-24 px-6 mx-auto" v-if="1 == 1">
    <section class="mb-32 text-gray-800 text-center">
      ...
      <div v-else>
        ...
        <div v-else class="grid lg:grid-cols-3 gap-6 xl:gap-x-12">
...
axios.get('//' + window.location.host + '/api/zemk/news').then((response) => {
