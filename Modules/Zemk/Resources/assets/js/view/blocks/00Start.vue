      ...
      >
        <div class="px-6 w-full flex flex-wrap items-center justify-between">
          ...
          >
            <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
              <li class="nav-item">
                ...
                >
                  Школа бильярда Александра Коновалова ттт72.рф 
                </a>
              </li>
              <!-- <li class="nav-item">
                <a
          ...
          <div class="flex items-center lg:ml-auto">
            Звоните:
            <a
              href="tel:+79222630618"
              type="button"
              class="inline-block pr-6 py-2.5 mr-2 bg-transparent text-blue-600 font-medium text-md leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
            >
              8-922-263-06-18
        ...
        <div class="container mx-auto xl:px-32">
          <div class="grid lg:grid-cols-2 gap-12 flex items-center">
            <div class="mt-12 lg:mt-0">
              <h1
                class="text-3xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12"
              >
                Тактика
                <br />
                Техника
                ...
                Точность
                <br />
                <span class="text-3xl text-blue-600">Обучение бильярду</span>
              </h1>
              <!-- <a
