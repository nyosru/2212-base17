                ...
                <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out"
                            href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">Regular link</a>
                    </li>
                            ...
                            <div class="px-6 lg:px-8 py-5">
                                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    ...
                                    <div class="bg-white text-gray-600">
                                        ...
                                        @foreach ($pages as $i)
                                            <a href="/service/page/{{ $i['link'] }}" aria-current="true"
                                                class="block px-6 py-2 border-b border-gray-200 w-full hover:bg-gray-50 hover:text-gray-700 transition duration-150 ease-in-out">
                                                {{ $i['name'] }}
                                            </a>
                                        @endforeach
                                    ...
                                    <div class="bg-white text-gray-600">
                                        ...
                                        <a href="/service/images" aria-current="true"
                                            class="block px-6 py-2 border-b border-gray-200 w-full hover:bg-gray-50 hover:text-gray-700 transition duration-150 ease-in-out">
                                            Картинки, загрузка картинок</a>
            ...
            @auth
                ...
                <div class="dropdown relative">
                    <a class="dropdown-toggle flex items-center hidden-arrow" href="#" id="dropdownMenuButton2"
                        ...
                        <img xsrc="https://mdbootstrap.com/img/new/avatars/2.jpg" src="{{ auth()->user()->avatar }}"
